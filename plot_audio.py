...
def plot_waveform_and_mel(path, save_dir=None, seed_value=42, mark_version="mark2.4.0"):
    set_seed(seed_value)
...
if __name__ == "__main__":
    test_audio_file = os.path.join(BASE_DIR, "data_wav", "daily_human_taking_22.wav")
